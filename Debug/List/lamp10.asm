...
; 0000 0089       PORTA=0x01;
	RCALL SUBOPT_0x0
; 0000 008A       PORTC=0x01;
; 0000 008B       delay_ms(100);
; 0000 008C 
; 0000 008D       PORTA=0x02;
	RCALL SUBOPT_0x1
; 0000 008E       PORTB=0x04;
; 0000 008F       delay_ms(100);
; 0000 0090 
; 0000 0091       PORTA=0x04;
	RCALL SUBOPT_0x2
; 0000 0092       PORTB=0x02;
; 0000 0093       delay_ms(100);
; 0000 0094 
; 0000 0095       PORTA=0x08;
	RCALL SUBOPT_0x3
; 0000 0096       PORTB=0x01;
; 0000 0097       delay_ms(100);
; 0000 0098 
; 0000 0099       PORTD=0x01;
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 009A       PORTD=0x02;
	LDI  R30,LOW(2)
	OUT  0x12,R30
; 0000 009B       delay_ms(100);
	...
	RCALL _delay_ms
; 0000 009C 
; 0000 009D       PORTA=0x08;
	RCALL SUBOPT_0x3
; 0000 009E       PORTB=0x01;
; 0000 009F       delay_ms(100);
; 0000 00A0 
; 0000 00A1       PORTA=0x04;
	RCALL SUBOPT_0x2
; 0000 00A2       PORTB=0x02;
; 0000 00A3       delay_ms(100);
; 0000 00A4 
; 0000 00A5       PORTA=0x02;
	RCALL SUBOPT_0x1
; 0000 00A6       PORTB=0x04;
; 0000 00A7       delay_ms(100);
; 0000 00A8 
; 0000 00A9       PORTA=0x01;
	RCALL SUBOPT_0x0
